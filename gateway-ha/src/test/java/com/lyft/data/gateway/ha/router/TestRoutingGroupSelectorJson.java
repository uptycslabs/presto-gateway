...
@Test
public class TestRoutingGroupSelectorJson {
    ...
    public Object[][] provideData() {
        ...
        return new Object[][] {
                { rulesDir + "routing_rules_atomic.json" },
                { rulesDir + "routing_rules_composite.json" },
                { rulesDir + "routing_rules_priorities.json" },
                { rulesDir + "routing_rules_if_statements.json" }
        };
    }
